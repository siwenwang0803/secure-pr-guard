...
class TestClass:
    ...
    # Long line comment that goes way beyond the recommended 120 character limit and should be wrapped or shortened 
    # according to style guidelines
variable_with_extremely_long_name_that_should_probably_be_shortened = "test"

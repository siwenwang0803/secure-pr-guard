...
def test_function():
	# 问题1: 使用Tab缩进而不是空格
	very_long_line_that_exceeds_one_hundred_twenty_characters_and_should_be_split_into_multiple_lines_for_better_readability = "This is a very long string"
	
	# 问题2: 变量名风格不一致
	VeryBadVariableName="bad style"
